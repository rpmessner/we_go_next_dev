...
- [`PUBLIC_MIRROR_DEPLOYMENT.md`](PUBLIC_MIRROR_DEPLOYMENT.md) — GitHub Actions, Gigalixir config, local upload setup, and smoke-test flow for the public mirror (ingest-specific parts to be rewritten by WE-32/WE-36).
