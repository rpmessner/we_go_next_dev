...
> **Archived:** This roadmap is historical. Its Midnight launch framing is obsolete as of the current 2026-05-18 board direction. Use [`../ROADMAP.md`](../ROADMAP.md) for the active frontend, fact/dimension, criteria, and medallion roadmap.

**Project:** WoW Combat Log Analysis Tool
**Target Launch:** Midnight Expansion Raids (March 2026)
**Last Updated:** 2026-05-16

> **Priority note:** The pre-April direction below — "raid leadership tool" — was later re-centered around **personal play first** and then superseded by the medallion warehouse board. Roadmap phases below are useful only as historical context.
